...
import 'package:kanban_board/models/item_state.dart' as KanbanListItem;
import '../models/item_state.dart' as LocalListItem;
// import '/home/fork/Documents/DOKUMEN PKL/ems/lib/app/modules/kanban/views/form_addTask.dart';
// import '../app/modules/kanban/views/form_addTask.dart';

class BoardList extends ConsumerStatefulWidget {
  const BoardList({super.key, required this.index,required this.idkanban});
  final int index;
  final int idkanban;
                  ...
                  prov.board.lists[widget.index].items.add(ListItem(
                      child: Container(
                        decoration: BoxDecoration(
                          ...
                          color:
                              prov.board.cardPlaceholderColor ?? Colors.white,
                        ),
                      ...
                      listIndex: widget.index,
                      index: 0,
                      addedBySystem: true) as KanbanListItem.ListItem);
